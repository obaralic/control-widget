...
public class Widget1x1ConfigureActivity extends BaseActivity {
    ...
    private static final String TAG = LogUtil.getTag(Widget1x1ConfigureActivity.class);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        analytics.sendEvent(FlurryCustomEvents.ON_WIDGET_1x1_INSTANTIATION, true);
        ...
        if (extras != null) {
            ...
            DatabaseTransactions.insertAndRefreshInstance1x1Info(this, appWidgetId);           
