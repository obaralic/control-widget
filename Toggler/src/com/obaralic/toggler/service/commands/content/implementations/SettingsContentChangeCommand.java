...
/**
 * Class that defines command for starting settings screen.
 */
public class SettingsContentChangeCommand extends ContentStateChangeServiceCommandTemplate {

    private static final String TAG = LogUtil.getTag(SettingsContentChangeCommand.class);
    ...
    public void doBeforeToggle(Context context) {
        ...
        analytics.sendEvent(FlurryCustomEvents.ON_SETTINGS_OPENED, true);
    }
    ...
    public void performToggle(Context context) {
        ...
        AnalyticsInterface analytics = AnalyticsFactory.get(AnalyticsProviderType.FLURRY_ANALYTICS);
        analytics.sendEvent(FlurryCustomEvents.ON_SETTINGS_OPENED);
    }
}
